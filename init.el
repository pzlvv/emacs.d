...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (company-jedi company-go nlinum web-mode yasnippet js2-mode company tide zenburn-theme evil-escape helm yaml-mode magit feature-mode go-mode go-impl window-numbering window-number python-mode popup-complete neotree markdown-mode lua-mode key-chord json-mode colemak-evil auto-auto-indent auctex)))
